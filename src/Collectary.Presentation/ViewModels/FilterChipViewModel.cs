...
public partial class ChipValueOption : ViewModelBase
{
...
public partial class FilterChipViewModel : ViewModelBase
{
    ...
    public string DisplayText
    {
        get
        {
            ...
            {
                0 => LocalizationService.Instance["SearchAllValues"],
                1 => selected[0],
                _ => string.Format(LocalizationService.Instance["SearchSelectedCount"], selected.Count),
            };
    ...
    public string OperatorHint => LocalizationService.Instance[
        TextOperator == QueryOperatorKind.Contains ? "SearchContainsLabel" : "SearchEqualsLabel"];
