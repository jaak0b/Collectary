...
namespace Collectary.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260621182351_MultiImageStoreFileNames")]
    partial class MultiImageStoreFileNames
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Collectary.Core.Domain.Fields.MultiImageFieldValue", b =>
                {
                    ...
                    b.OwnsMany("Collectary.Core.Domain.Fields.MultiImagePicture", "Pictures", b1 =>
                        {
                            b1.Property<Guid>("OwnerValueId")
                                .HasColumnType("TEXT");
                            ...
                            b1.ToTable("MultiImagePictures", (string)null);
